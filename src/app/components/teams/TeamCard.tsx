  ...
  return (
    ...
    >
      ...
      <Card
        ...
        className="h-full min-h-[500px] bg-gradient-to-br from-card via-card/95 to-card/90 backdrop-blur-xl border border-border/60 hover:border-border shadow-lg hover:shadow-2xl transition-all duration-500 cursor-pointer overflow-hidden relative group/card"
      >
