                ...
                <Link href="/dashboard">
                  <>
                    ...
                    <div className="sm:hidden">
                      <Button 
                        size="sm" 
                        className="gradient-primary text-primary-foreground hover-glow text-sm px-4 py-2 rounded-full font-semibent shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105"
                      >
                        Dashboard
                        <ArrowRight className="ml-1 h-4 w-4" />
                      </Button>
