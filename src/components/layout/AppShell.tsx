...
export default function AppShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-background">
      {/* Sidebar (desktop) */}
      <aside className="hidden lg:flex w-64 flex-col border-r bg-card min-h-screen fixed inset-y-0 left-0 z-40">
          ...
          <div className="flex items-center justify-between px-4 lg:px-8 py-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="relative" ref={userMenuRef}>
                ...
                {userMenuOpen && (
                  <div className="absolute right-0 mt-2 w-56 rounded-lg border bg-card shadow-xl p-2 z-10">
                    ...
                    <button
                      ...
                      className="mt-1 w-full inline-flex items-center gap-2 text-sm px-3 py-2 rounded-md hover:bg-red-50 dark:hover:bg-red-500/10 text-red-600 dark:text-red-400 transition-colors"
                    >
        ...
        {mobileNavOpen && (
          <>
            ...
            <motion.aside
              ...
              className="fixed inset-y-0 left-0 w-72 max-w-[85vw] bg-white dark:bg-slate-900 border-r shadow-xl z-50 lg:hidden flex flex-col"
              role="dialog"
      ...
      <AnimatePresence>
        {feedbackOpen && (
          <motion.aside
            ...
            transition={{ type: "spring", stiffness: 300, damping: 30 }}
            className="fixed top-0 right-0 h-full w-full max-w-[92vw] sm:w-[380px] bg-white dark:bg-slate-900 border-l shadow-xl z-50"
            role="dialog"
      ...
      <AnimatePresence>
        {featureOpen && (
          <motion.aside
            ...
            exit={{ x: 400, opacity: 1 }}
            transition={{ type: "spring", stiffness: 300, damping: 30 }}
            className="fixed top-0 right-0 h-full w-full max-w-[92vw] sm:w-[420px] bg-white dark:bg-slate-900 border-l shadow-xl z-50"
            role="dialog"
