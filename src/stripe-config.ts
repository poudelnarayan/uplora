...
export const PLANS: Plan[] = [
  ...
  },
  {
    id: "creator",
    name: "Creator",
    tagline: "Solo creators publishing to every platform",
    description: "For solo creators publishing to every platform every week.",
    monthlyPrice: 19,
    ...
    features: [
      { label: "1 workspace, 1 seat", included: true },
      { label: "All 8 platforms", included: true, note: "YouTube, IG, X, FB, LI, TikTok, Threads, Pinterest" },
      ...
      { label: "AI cover image generator", included: true, note: "20 / mo" },
